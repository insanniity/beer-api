...
public class BeerControllerTest {
    ...
    private BeerDTO beer = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    void whenPOSTIsCalledThenABeerIsCreated() throws Exception {
        when(beerService.createBeer(beer)).thenReturn(beer);
        ...
        mockMvc.perform(post(BEER_API_URL_PATH)
                ...
                .andExpect(jsonPath("$.type", is(beer.getType().toString())));
    }
    ...
    void whenGETIsCalledWithValidNameThenOkStatusIsReturned() throws Exception {
        when(beerService.findByName(beer.getName())).thenReturn(beer);

        mockMvc.perform(MockMvcRequestBuilders.get(BEER_API_URL_PATH + "/" + beer.getName())
                .contentType(MediaType.APPLICATION_JSON))
    ...
    void whenGETIsCalledWithoutRegisteredNameThenNotFoundStatusIsReturned() throws Exception {
        when(beerService.findByName(beer.getName())).thenThrow(BeerNotFoundException.class);
    ...
    void whenGETListWithBeersIsCalledThenOkStatusIsReturned() throws Exception {
        when(beerService.listAll()).thenReturn(Collections.singletonList(beer));
        mockMvc.perform(MockMvcRequestBuilders.get(BEER_API_URL_PATH)
                ...
                .andExpect(jsonPath("$[0].type", is(beer.getType().toString())));
    }
    ...
    void whenDELETEIsCalledWithValidIdThenNoContentStatusIsReturned() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.delete(BEER_API_URL_PATH + "/" + beer.getId())
                .contentType(MediaType.APPLICATION_JSON))
    ...
    void whenPATCHIsCalledToIncrementGreatherThanMaxThenBadRequestStatusIsReturned() throws Exception {
        ...
        beer.setQuantity(beer.getQuantity() + quantityDTO.getQuantity());
    ...
    void whenPATCHIsCalledToDEcrementLowerThanZeroThenBadRequestStatusIsReturned() throws Exception {
        ...
        when(beerService.decrement(VALID_BEER_ID, quantityDTO.getQuantity())).thenThrow(BeerStockDoesNotContainException.class);
